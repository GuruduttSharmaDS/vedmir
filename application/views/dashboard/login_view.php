      ...
      <div class="card-body">
        <form action="" method="post">
          ...
          <div class="input-group form-group">
            ...
            <input type="email" class="form-control" placeholder="Email address" value="<?php echo (isset($_COOKIE['cookieVedmir'.$role])) ? $_COOKIE['cookieVedmir'.$role] : ""; ?>" name="txtEmailId" required>
