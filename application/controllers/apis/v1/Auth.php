...
class Auth extends REST_Controller {
    ...
    // Login multiple roles like user, restaurant, admin 
    ...
    public function signup_post(){
        ...
        if($insertStatus){
            ...
            $insertTokensStatus = 0;  
            $insertTokensStatus = $this->Common_model->insert('vm_api_token',array('role' => 'user','roleId' => $insertStatus,'emailId' => $_POST['email'],'token' => $token));
            ...
            $this->response(['status' => TRUE,'message' => $this->lang->line('successRegister'),'token' => $token, 'data' => $users] , REST_Controller::HTTP_OK);
